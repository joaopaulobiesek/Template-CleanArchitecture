...
namespace Template.Application.Domains.ExternalServices.Google.Queries.CalendarEvents;
...
public class GetCalendarEventsQueryHandler : HandlerBase<GetCalendarEventsQuery, List<GoogleCalendarEvent>>
{
    ...
    public GetCalendarEventsQueryHandler(IContext context, HandlerDependencies<GetCalendarEventsQuery, List<GoogleCalendarEvent>> dependencies, IGoogle google) : base(context, dependencies)
    {
        _google = google;
