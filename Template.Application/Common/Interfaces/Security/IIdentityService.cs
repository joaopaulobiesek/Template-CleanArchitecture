...
public interface IIdentityService
{
    ...
    Task<ApiResponse<string>> HandleExternalLoginAsync(string provider, string providerKey, string email, string name, string? picture);
    Task<(string loginProvider, string providerKey, string email, string name)> GetExternalLoginInfo();
